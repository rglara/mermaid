...
import type { StorymapDB /*, TreemapNode*/ } from './types.js';
...
const draw: DrawDefinition = (_text, id, _version, diagram: Diagram) => {
  const _storymapDb = diagram.db as StorymapDB;
  ...
  const _svg = selectSvgElement(id);
...
const getClasses = function (
  ...
  return (diagramObj.db as StorymapDB).getClasses();
};
